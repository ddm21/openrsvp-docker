...
## License
OpenRSVP is 100% free to self-host. You are permitted to self-host and modify the software for your own events without any artificial limits. Reselling the software as a service is prohibited under the EULA (`LICENSE.md`).
